<script>
  ...
  async function handleLogin() {
    ...
    try {
      ...
      errorMessage = error instanceof Error ? error.message : 'Failed to authenticate';
      isLoading = false;
    }
  }
...
<main>
        ...
        <div class="accounts-grid">
          {#each followedAccounts as account}
            <div class="account-card">
              <img src={account.avatar || 'https://bsky.social/static/default-avatar.png'} alt={account.displayName || account.handle} />
  ...
  <footer>
    <div class="footer-content">
      ...
      <ol>
        <li><strong>PKCE Setup:</strong> We generate a code verifier and code challenge to secure the auth flow.</li>
        <li><strong>DPoP Keypair:</strong> We create a unique keypair that binds the access token to this specific client.</li>
        <li><strong>Authorization Request:</strong> Redirect to Bluesky with our client ID and PKCE challenge.</li>
        <li><strong>User Authentication:</strong> User logs in on Bluesky and grants our app permissions.</li>
        <li><strong>Callback:</strong> Bluesky redirects back to our callback page with an authorization code.</li>
        <li><strong>Token Exchange:</strong> We exchange the code for access and refresh tokens.</li>
        <li><strong>API Access:</strong> We use the tokens with DPoP to make authenticated API requests.</li>
      </ol>
    </div>
  </footer>
</main>
